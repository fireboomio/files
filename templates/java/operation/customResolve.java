...
@Slf4j
@Component(value = "operation/<%= it.operationName %>/CustomResolve")
public class CustomResolve extends OperationHooks<<%= it.operationName %>InternalInput, <%= it.operationName %>ResponseData> {
