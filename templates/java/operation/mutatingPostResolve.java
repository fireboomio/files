...
@Slf4j
@Component(value = "operation/<%= it.operationName %>/MutatingPostResolve")
public class MutatingPostResolve extends OperationHooks<<%= it.operationName %>InternalInput, <%= it.operationName %>ResponseData> {
