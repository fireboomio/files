...
@Slf4j
@Component(value = "operation/<%= it.operationName %>/PostResolve")
public class PostResolve extends OperationHooks<<%= it.operationName %>InternalInput, <%= it.operationName %>ResponseData> {
