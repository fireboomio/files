...
@Slf4j
@Component(value = "operation/<%= it.operationName %>/MutatingPreResolve")
public class MutatingPreResolve extends OperationHooks<<%= it.operationName %>InternalInput, <%= it.operationName %>ResponseData> {
