...
@Slf4j
@Component(value = "operation/<%= it.operationName %>/MockResolve")
public class MockResolve extends OperationHooks<<%= it.operationName %>InternalInput, <%= it.operationName %>ResponseData> {
