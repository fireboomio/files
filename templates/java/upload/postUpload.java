...
@Slf4j
@Component(value = "storage/<%= it.providerName %>/<%= it.profileName %>/PostUpload")
public class PostUpload extends UploadProfileHooks<<%= it.providerName %>_<%= it.profileName %>ProfileMeta> {
